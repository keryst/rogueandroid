...
/**
 * TravelAnimationFrameSequence implements the AnimationFrameSequence interface
 ...
 * 
 */
public class TravelAnimationFrameSequence implements AnimationFrameSequence {

    final private int mStartFrame;
    final private int mStopFrame;

    final static int FRAME_COUNT = 8;
    final static int POS_X_START_FRAME = 1;
    ...
    /**
     * Class constructor that uses Direction to set the start and stop frames
     * for the Rokon sprite animation.
     * 
     * @param facing
     *            The direction that the entity is facing.
     * 
     */
    public TravelAnimationFrameSequence(Direction facing) {
        switch (facing) {
        case POS_X:
