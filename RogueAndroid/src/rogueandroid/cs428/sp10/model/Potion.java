...
/**
 * Potion is an object in the dungeon that can picked up and heals the character
 * 
...
public class Potion extends Item {
    ...
    /**
     * The character uses the potion, expending one of its uses, and bestowing
     * the potion's bonuses on the character
     * @param character - The character that is consuming the potion
     */      
